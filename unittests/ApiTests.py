...
class ApiTest(unittest.TestCase):
    ...
    def test_01_train(self):
        ...
        r = requests.post('http://0.0.0.0:{}/train'.format(port),
                          json=request_json)
        print(r.text)
        train_complete = re.sub("\W+","",
                                r.text)
        self.assertEqual(train_complete,
                         'true')
    ...
    def test_03_predict(self):
        ...
        query_data = {'country': 'hong_kong', 'year': '2018', 'month':'07', 'day':'20'}
