...
from localLogger import update_train_log, update_predict_log
...
class LoggerTest(unittest.TestCase):
    ...
    def test_01_train(self):
        ...
        update_train_log(country, data_shape, eval_test, runtime,
    ...
    def test_03_predict(self):
        ...
        model_version = 0.1
        country = 'hong_kong'
        target_date = '2018-07-20'

        update_predict_log(country=country,
                           y_pred=y_pred,
                           y_proba=y_proba,
